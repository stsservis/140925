...
const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  }, [backgroundImageUrl, gradientColors, overlayColor, overlayOpacity]);
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-2">
                Arka Plan Karartma/Soldurma
              </label>
              <div className="space-y-3">
                <div>
                  <label className="block text-xs text-zinc-400 mb-1">Overlay Rengi</label>
                ...
                <div>
                  <label className="block text-xs text-zinc-400 mb-1">
                    Yoğunluk: {Math.round(localOverlayOpacity * 100)}%
                  </label>
                  <input
                    type="range"
                    min="0"
